...
export default class Webcam extends React.Component<WebcamProps, WebcamState> {
  ...
  private requestUserMediaId: number = 0;
  private unmounted: boolean = false;
  private requestedUserMedia: boolean = false;
  ...
  componentDidMount() {
    ...
    if (!state.hasUserMedia && !this.requestedUserMedia) {
  ...
  private requestUserMedia() {
    ...
    if ("mediaDevices" in navigator) {
      ...
      MediaStreamTrack.getSources((sources: any) => {
